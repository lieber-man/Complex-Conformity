...
function draw() {
  ...
  push();
  fill(255, 255, 255);
  text("Wahrheitsempfindlichkeit: " + truthSensitivity.value(), 10, 50);
  text("Gewichtung nach Meinung: " + echoWeight.value(), 10, 100);
  text("Gewichtung der Minderheit:" + normWeight.value(), 10, 150);
  text("Anzahl Boids: " + slider.value(), 10, 200);
